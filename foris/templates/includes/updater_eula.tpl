<p>
  {{ trans("Router Turris Omnia is equipped with the unique function of automatic system updates. Thanks to this function your router's software stays up to date and offers better protection against attacks from the Internet. Before you turn this function on, please read the following key points:") }}
</p>
