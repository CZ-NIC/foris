...
<p>{{! trans("It is <strong>highly recommended</strong> to have this feature <strong>turned on</strong>, but there may be reasons for you to decide otherwise. However, be warned that this might weaken the security of your router and network in case flaws in the software are found.") }}</p>
