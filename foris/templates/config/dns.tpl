...
<div id="page-dns" class="config-page">
    ...
    %if DEVICE_CUSTOMIZATION == "omnia":
      <p class="message warning">{{ trans("If you encounter problems with the DNSSEC validation, you can try disabling it. However, it is strongly recommended not do to so. Most common cause for problems with the DNSSEC is invalid configuration of your ISP's network. Try contacting them first to resolve the issues.") }}</p>
    %end
