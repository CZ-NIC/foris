...
<head>
    ...
    <link href="{{ static("css/screen.css") }}?md5=0decc4798aa2a38686424c0cf17ad6df" rel="stylesheet" media="screen">
    <!--[if lt IE 9]>
    ...
    <script src="{{ static("js/parsley.foris-extend.min.js") }}?md5=1752816dbb828cd1ce0bf70427e005e9"></script>
